...
disease_ontology = doid.get_nx_ontology()
...
for pair in tissue_doid_pairs:
    ...
    disease_ontology.propogate_annotation(disease_id, 'tissues', tissue)
...
for tissue_mapping in read_input('tissue-to-meddra'):
    ...
    meddra_ontology.propogate_annotation(meddra_code, 'tissues', gep_tissue)
