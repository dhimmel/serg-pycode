...
def create_expressnet(network_id, indication_path):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--indication-path', 
        default = '/home/dhimmels/Documents/serg/ictnet/ictnet-creation/output-tables/tb_disease_drug_net.txt')
    args = parser.parse_args()

    g = create_expressnet(args.network_id, args.indication_path)
